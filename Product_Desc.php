...
<?php
    ...
    $select=mysqli_query($conn,"SELECT * FROM `product` WHERE `product`.`Id` =$id;");
...
<div class="content">
<img src="uploaded_img/<?php echo $row['Image'];?>" height="450px"  width="450px" alt=" ">

<p style="padding-left: 80px; font-size:30px; text-align:left; "><i><b>Puro Chocolate Cake</b></i></p>
...
<div class="desc">
<p style="text-align: center;"><u>Puro Baklava Bokas 175 Gm</u>
...
<p style="padding-left: 15px; font-size:20px; text-align:left; ">Price : <b><?php echo $row['Price'];?>.00 ৳</b>

<br>
<p style="padding-left: 15px; font-size:20px; text-align:left; "><b>Delivery available in: </b>Whole Dhanmondi,  Zigatola, Mohammadpur, Gulshan 1 & 2, Baridhara, Baridhara DOHS, Banani, Banani DOHS, Shahzadpur, Notunbazar, Badda, Badda link road, Niketon, Hatirjheel.</p>

<p style="padding-left: 15px; font-size:20px; text-align:left; "> SKU: <b>90002</b></p>

<p style="padding-left: 15px; font-size:20px; text-align:left; ">Category: <b>Oriental Sweets</b></p>

<a href="Cart.php?cake=<?php echo $row['Id']; ?>" class="btn1">
